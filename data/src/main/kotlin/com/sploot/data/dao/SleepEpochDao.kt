...
interface SleepEpochDao {
    ...
    @Query("SELECT * FROM sleep_epochs WHERE epochStartSeconds >= :fromSeconds AND source = :source ORDER BY epochStartSeconds ASC")
    suspend fun getSince(fromSeconds: Long, source: String): List<SleepEpochEntity>
